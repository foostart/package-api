...
CREATE TABLE `apis` (
  ...
  `api_overview` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `api_description` text CHARACTER SET utf8,
  `api_slug` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `api_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `apis` (`api_id`, `user_id`, `user_email`, `user_full_name`, `category_id`, `api_name`, `api_overview`, `api_description`, `api_slug`, `api_image`, `api_files`, `api_status`, `created_at`, `updated_at`) VALUES
